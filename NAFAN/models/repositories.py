...
class Repository(models.Model):
    ...
    # Operations fields
    # These represent information used by NAFAN to process finding aids.  There is no delusion that these represent
    # all or that these are even the best choices until implementation.  It's also easily conceivable that these
    # would be in a separate table

    # harvest location - where a set of finding aids would be found
    # harvest format - what the file format of the finding aids would be
    # default finding aid values
    #   conditions govening access
    #   physical access
    #   etc.
    ...
    def GetOrganizations(searchField, searchTerm):
        results = []
